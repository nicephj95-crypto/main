...
const result = await page.evaluate(() => ({
  actionButtons: Array.from(document.querySelectorAll('table.addressbook-table tbody tr td:last-child button')).map((b) => ({
    text: b.textContent,
    aria: b.getAttribute('aria-label'),
    title: b.getAttribute('title'),
    className: b.className,
  })),
  actionCellHtml: document.querySelector('table.addressbook-table tbody tr td:last-child')?.innerHTML ?? null,
}));
